-- BONDADA FOUNDATION — FRESH SCHEMA (GoDaddy/cPanel compatible)
-- Select bondada_foundation in phpMyAdmin before importing.
-- This file intentionally contains NO CREATE DATABASE, USE, DEFINER or DROP.
-- Academic fields remain JSON because the frontend scholarshipConfig.js is dynamic.
-- Generated from the reviewed backend/frontend contract.
...
CREATE TABLE scholarship_applications (
    ...
    parent_guardian_aadhaar VARCHAR(12) NOT NULL,
    ...
    INDEX idx_app_aadhaar_program_created (scholarship_program_id, aadhaar_number, created_at),
